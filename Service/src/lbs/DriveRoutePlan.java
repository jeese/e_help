...
public class DriveRoutePlan extends Activity implements OnClickListener,
		AMapNaviListener {

	// 步行导航按钮
	private Button driveNaviButton;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.drivenav);
		// 目的地位置经纬度
	...
	private void initView(Bundle savedInstanceState) {
		...
		driveNaviButton = (Button) findViewById(R.id.drivenav_walk);
		driveNaviButton.setOnClickListener(this);

		mMapView = (MapView) findViewById(R.id.drivenav_mapview);
	...
	private void calculateDriveRoute() {
		...
		switch (mDriveMode){
		case 0:
			isSuccess = mAMapNavi.calculateDriveRoute(mStartPoints,
	...
	private void startGPSNavi() {
		if (mIsCalculateRouteSuccess) {
			Intent gpsIntent = new Intent(DriveRoutePlan.this, mNaviPage.class);
