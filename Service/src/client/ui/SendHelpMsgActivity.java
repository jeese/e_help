...
public class SendHelpMsgActivity extends Activity implements OnLongClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lo=new Location(SendHelpMsgActivity.this);
	    ...
	    btn_video.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(SendHelpMsgActivity.this,Video.class);  
			     ...
			     case MotionEvent.ACTION_UP:
			    	 ...
			    	 try{
			    		 System.out.print("******进入try");
							...
							Toast.makeText(SendHelpMsgActivity.this, "录音成功" + audio_file, Toast.LENGTH_SHORT).show();
						}catch(Exception e) {
