...
public class SendLifeHelpActivity extends Activity implements OnLongClickListener{

	private static final String[] sen={"常用语句", "脚扭伤了","没带家钥匙","迷路了","东西太重了"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sendlifehelp_activity);
		...
		lo=new Location(SendLifeHelpActivity.this);
	    ...
	    btn_video.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(SendLifeHelpActivity.this,Video.class);  
	...
	private class Send extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {   	
        	...
        	if(result.equals("network error")){
        		Toast.makeText(SendLifeHelpActivity.this,"您还没有联网", Toast.LENGTH_SHORT).show();
            	//pro.setVisibility(View.INVISIBLE);
        	}
        	if(result.equals("error")){
        		Toast.makeText(SendLifeHelpActivity.this,"连接服务器失败", Toast.LENGTH_SHORT).show();
            	//pro.setVisibility(View.INVISIBLE);
        	}
            try {
            	switch (new JSONObject(result).getInt("state")) {
            	case 1:
            		Toast.makeText(SendLifeHelpActivity.this, "发送成功", Toast.LENGTH_SHORT).show();
            		ControlActivity.SetPager(1);
            		finish();
            		break;
            	default:
            		Toast.makeText(SendLifeHelpActivity.this, "发送失败", Toast.LENGTH_SHORT).show();
            	}
	...
	//新加入的代码 8/5
				     ...
				     case MotionEvent.ACTION_UP:
				    	 ...
				    	 try{
				    		 System.out.print("******进入try");
								...
								Toast.makeText(SendLifeHelpActivity.this, "录音成功" + audio_file, Toast.LENGTH_SHORT).show();
							}catch(Exception e) {
		...
		protected void recorder(){
			//try{
				...
				Toast.makeText(getApplicationContext(), "SD存在", Toast.LENGTH_SHORT).show();
