...
public class RadialMenuWidget extends View {
	...
	private int wedge2Color = Color.rgb(50, 50, 50); // default color of wedge
														// pieces
	private int wedge2Color1 = Color.rgb(50,50,50);
	private int wedge2Color2 = Color.rgb(50, 50, 50);
	private int wedge2Color3 = Color.rgb(50, 50, 50);
	...
	//private int selectedColor = Color.rgb(70, 130, 180); // color to fill when
															...
															// selected
															//pale blue
	private int selectedColor = Color.rgb(255, 222, 173); 
	...
	public boolean onTouchEvent(MotionEvent e) {
		...
		//setSourceLocation(eventX, eventY);
	...
	protected void onDraw(Canvas c) {
		...
		if (showSource == true) {
			paint.setColor(wedge2Color1);
			paint.setAlpha(wedge2Alpha);
			paint.setStyle(Paint.Style.STROKE);
			c.drawCircle(xSource, ySource, cRadius / 2, paint);

			paint.setColor(wedge2Color1);
			paint.setAlpha(wedge2Alpha);
			paint.setStyle(Paint.Style.FILL);
			c.drawCircle(xSource, ySource, cRadius / 5, paint);
		}
//inner
		for (int i = 0; i < Wedges.length; i++) {
			RadialMenuWedge f = Wedges[i];
...
//outer
		if (Wedge2Shown == true) {
			...
			for (int i = 0; i < Wedges2.length; i++) {
				...
				if (f == selected2) {
					...
					if(i==0)paint.setColor(wedge2Color1);
					if(i==1)paint.setColor(wedge2Color2);
					if(i==2)paint.setColor(wedge2Color3);
					paint.setAlpha(wedge2Alpha);
					paint.setStyle(Paint.Style.FILL);
					c.drawPath(f, paint);
				}
	...
	public void setOuterRingColor(int color1, int color2, int color3)
	{
		this.wedge2Color1 = color1;
		this.wedge2Color2 = color2;
		this.wedge2Color3 = color3;
	}
	 ...
	 */
	public void show() {
		mWindow.showAtLocation(getRootView(), 0, 200, 200);;
	}
